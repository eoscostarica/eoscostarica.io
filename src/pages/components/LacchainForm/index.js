  ...
  const ContactForm = () =>{
    ...
    const sendData = async () => {
      const jsonData = {
          ...
          "context": {
            "pageUri": "https://eoscostarica.io/lacchain",
      ...
      <Box>
        <form onSubmit={onSubmitForms} noValidate> 
          <Grid container spacing={2}> 
            ...
            <Grid item xs={12} md={6}>
              <label htmlFor="companyName_contact">Organization or company</label>
                <Box className="inputFormBox">
                    <GenericInput 
      ...
      {isDesktop && 
        <Box className="containerSec">
          <Box className="section">
            <Box className="h3Box">
              <h1>Create a LACChain EOSIO Account</h1>
            </Box>
            {!resultsSection && 
              <Box className="contactFormBox">
                <Box className="spacingBox">
                  <p>Ready to create an account and start using LACChain EOSIO? Contact us!</p>
                </Box>
                <ContactForm />
              </Box>
            }
