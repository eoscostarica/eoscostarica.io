      ...
      <Box className={clsx("container", styles.noPadding)}>
        ...
        >
          <Box>
            ...
            <Box className={styles.titleBox}>
              ...
              <Typography variant="h2">by Industry</Typography>
            </Box>
        ...
        >
          <Box className={styles.enterpriceTitleBox}>
            <Typography variant="h1">Blockchain in More Industries</Typography>
          </Box>
          ...
          <Box className={styles.enterpriceTitleBox}>
            <Box className={clsx(styles.colBox, styles.flexContent)}>
              <Box className={styles.flexBox}>
                <Box>
                  <Typography variant="h3">Privacy and transparency</Typography>
                  <Typography variant="body1">
                ...
                <Box>
                  <Typography variant="h3">Cost-efficiency</Typography>
                  <Typography variant="body1">
                ...
                <Box>
                  <Typography variant="h3">Quick adoption</Typography>
                  <Typography variant="body1">
                ...
                <Box>
                  <Typography variant="h3">Speed or throughput</Typography>
                  <Typography variant="body1">
        ...
        <Box className={clsx(styles.sectionGray, styles.enterpriceBox)}>
          ...
          >
            <Typography variant="h1" className={styles.titleH1}>Additional Resources</Typography>
            <Typography variant="body1">
