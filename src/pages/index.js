      ...
      <Box className="containerSec">
        {isDesktop && (
          <Box className="sectionHero">
            <Box className="titleBox">
              <h1>
                Enterprise Blockchain Solutions <br /> That Fit Your Needs
              </h1>
            </Box>
            <p>
              Deploy EOSIO + Antelope{" "}
              <a href="https://eoscostarica.io/blog/what-is-blockchain">
                blockchain technology
              </a>{" "}
              to improve transparency, boost efficiency, and reduce costs. Start
              transforming your organization by leveraging enterprise blockchain
              networks.
            </p>
        ...
        {isMobile && (
          <Box className="sectionHeroMobile">
            <Box className="titleBox">
              <h1>
                Enterprise Blockchain <br /> Solutions That <br /> Fit Your
                Needs
              </h1>
            </Box>
            <p>
    ...
    return (
      <Box className="containerSec">
        <Box className={clsx("section", { ["sectionPadding"]: isMobile })}>
          <Box className="titleBox">
            {isDesktop && <h2>What Enterprise Blockchain Can Do</h2>}
            {isMobile && (
              <>
                <h2>
                  What Enterprise <br /> Blockchain Can Do
                </h2>
              </>
            )}
          </Box>
          <Grid container spacing={5}>
            <Grid item xs={12} md={6}>
              ...
              <p>
                ...
                registers transactions in chronological order, enabling full
                traceability of data that can be accessed in near real-time.
                These registries are immutable, meaning they cannot be altered,
                thus offering higher transparency in processes.
              </p>
            </Grid>
            <Grid item xs={12} md={6}>
              <Box className="h3Box">
              ...
              <Grid justify="center" container>
                <Grid item xs={11}>
                  <h4 style={{ textAlign: "center" }}>
                    <b>
                      Learn more about how blockchain can improve your
                      operations.
                    </b>
                  </h4>
                </Grid>
          ...
          <Grid container spacing={5}>
            <Grid item xs={12} md={6}>
              ...
              <p>
                ...
                <a href={useBaseUrl("/contact-us")}>Contact us</a> and get the
                ...
                >
                  ...
                  <AccordionDetails style={{ padding: 1, marginTop: "-15px" }}>
                    <p style={{ padding: 0 }}>
                      ...
                      without compromising thought leadership or quality. Our
                      team is technology agnostic but specializes in the
                ...
                >
                  ...
                  <AccordionDetails style={{ padding: 0, marginTop: "-15px" }}>
                    <p style={{ padding: 0 }}>
                      ...
                      Rica. Costa Rica is a country with high political
                      stability and a long-lasting democracy. Our strategic
                      location in Central America offers convenient network
                      interconnectivity. We also configure, host, and maintain
                      blockchain nodes available for private and public networks
                      with 24/7 monitoring and uptime.{" "}
                      <a href={useBaseUrl("/the-company")} target="_blank">
                        {" "}
                ...
                >
                  ...
                  <AccordionDetails style={{ padding: 0, marginTop: "-15px" }}>
                    <p style={{ padding: 0 }}>
                      ...
                      transform many industries. We offer workshops on
                      blockchain and EOSIO + Antelope to C-suite executives and
                      teams that want to keep up to date and learn more about
                      what is blockchain and enterprise use cases. We also
                      provide training and education resources for new talents
                      that wish to kickstart their career in blockchain.
                    </p>
                  </AccordionDetails>
                </Accordion>
              </Box>
  ...
  const EnterpriseBlockchain = () => {
    return (
      <Box className="containerSec">
        <Box className="sectionPadding">
          <Box className="titleBox">
            {isDesktop && <h2>Industries to Deploy Enterprise Blockchain</h2>}
            {isMobile && (
              <>
                <h2>
                  Industries to Deploy <br /> Enterprise Blockchain
                </h2>
              </>
            )}
          </Box>
          <Box className="spacingBox">
            <Grid container spacing={5}>
              ...
              <Grid item md={4}>
                ...
                <p>
                  In an industry that involves dozens of stakeholders,
                  blockchain's capabilities to manage authorizations and
                  automate and trace operations can make a great ally.{" "}
                  <a href={"https://eoscostarica.io/blog/blockchain-logistics"}>
                    {" "}
                    Read more
                  </a>
                </p>
              ...
              <Grid item md={4}>
                ...
                <p>
                  ...
                  <a href={"https://eoscostarica.io/blog/gaming-blockchain"}>
                    {" "}
                    Read more
                  </a>
                </p>
              ...
              <Box className="inquiereBox">
                <Box style={{ width: "100%" }}>
                  <h2 className={clsx("white", "centerTextOnMobile")}>
                    Do you Have Inquiries <br /> About Blockchain?{" "}
                  </h2>
                  <Box className="buttonBox">
                    <button
                      className="buttonPrimary"
            ...
            <Box className="spacingBox">
              <Grid container spacing={5}>
                ...
                <Grid item md={6}>
                  ...
                  <p>
                    During the 1980s, we developed the first BBS in the country,
                    a precursor to the internet. After decades of offering
                    internet infrastructure, hosting, and development services,
                    we began providing infrastructure for public blockchain
                    networks. We were there during the genesis of the EOS
                    Mainnet and started deploying the{" "}
                    ...
                    protocol since its launch, accruing decades of experience
              ...
              <Grid container spacing={5}>
                <Grid item md={6}>
                  ...
                  <p>
                    ...
                    technology, an open-source protocol launched in 2018.
                    Antelope offers improved scalability due to its high
                    transaction speed, flexibility in public and private
                    networks, and energy efficiency compared to other
                    blockchains, making it a more eco-friendly option.
                  </p>
                </Grid>
                <Grid item md={6}>
                  <Box className="imgBoxRight">
    ...
    return (
      <Box className="containerSec">
        ...
        >
          ...
          <Box className="spacingBox">
            <p>
              Get to know some of our latest projects deploying the Antelope
              blockchain protocol.
              <a href={useBaseUrl("/projects")} target="_blank">
                {" "}
            ...
            <Grid container>
              ...
              <Grid item xs={12} md={6}>
                <Box className="projectsGridRight">
                  ...
                  <p>
                    We are part of LACChain EOSIO, an open-source initiative
                    that offers an EOSIO + Antelope blockchain network that
                    integrates into LACChain.{" "}
              ...
              <Grid style={{ backgroundColor: "#f8f8f8" }} item xs={12} md={6}>
                <Box className="projectsGridRight">
                  ...
                  <p>
                    EOS Rate is an open- source app that allows EOS token
                    holders to access a rating system and voting portal for
                    block producers and proxies in the EOS blockchain.{" "}
