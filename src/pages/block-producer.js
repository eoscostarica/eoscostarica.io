      ...
      <Box className={clsx("container", styles.noPadding)}>
        ...
        >
          <Box>
            ...
            <Box className={styles.titleBox}>
              <Typography variant="h2">EOS Block Producer</Typography>
            </Box>
        ...
        <Box className={clsx(styles.sectionWhite, styles.enterpriceBox)}>
          <Box className={styles.enterpriceTitleBox}>
            <Typography variant="h1" className={styles.titleH1}>Our Story</Typography>
            <Typography variant="body1">
        ...
        <Box className={clsx(styles.sectionWhite, styles.industryBox)}>
          <Box className={styles.industryTitleBox}>
            <Typography variant="h1">Block Producer Information</Typography>
          </Box>
          <Box className={clsx(styles.titleH1)}>
            <Typography variant="h3" className={styles.titleH1}>Code of conduct</Typography>
          ...
          <Typography variant="h3" className={styles.titleH1} id="ownership-disclosure">
        ...
        >
          <Box className={styles.industryTitleBox}>
            <Typography variant="h1">Open-source Projects</Typography>
          </Box>
          <Typography variant="body1">
        ...
        <Box className={clsx(styles.sectionWhite, styles.enterpriceBox)}>
          <Box className={clsx(styles.enterpriceTitleBox, styles.titleH1)}>
            <Typography variant="h1" className={styles.titleH1}>Why Costa Rica?</Typography>
            <Typography variant="body1">
        ...
        >
          <Box className={clsx(styles.enterpriceTitleBox, styles.titleH1)}>
            <Typography variant="h1" className={styles.titleH1}>Vote for Us as Block Producers</Typography>
          </Box>
          <Box className={styles.colBox}>
            <Box className={styles.enterpriceInfoBox}>
