            ...
            <div className={clsx(styles.colBox, styles.flexContent)}>
              <div className={styles.flexBox}>
                <div>
                  <h3>Our Story</h3>
                  <span>
                    EOS Costa Rica is part of a company with over three decades
                    of developing innovative technologies. During the 80s, we
                    launched the first BBS (bulletin board service) in the
                    country, a precursor to the internet. Later on, the company
                    shifted to educating new users on using the email and
                    browsing the web! Then, we started offering internet
                  ...
                  <span>
                    ...
                    learning how to deploy it in the real world. Our presence
                    grew during the genesis of the EOS Mainnet and will continue
                    to be there throughout its growth.
                  </span>
                </div>
                <div>
                  <h3>Our vision</h3>
                  ...
                  <span>
                    ...
                    to quickly and efficiently iterate and test
                ...
                <div>
                  ...
                  <span>
                    ...
                    blockchain ecosystem by participating in events, seminars,
                    and conferences.
                  </span>
                </div>
              </div>
